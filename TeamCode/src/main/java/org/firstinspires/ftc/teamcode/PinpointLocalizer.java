...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2.0 / 0.002; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -7.5 / 0.002; // x position of the perpendicular encoder (in tick units)
    }
